      ...
      <div className="mb-6">
        <div className="flex flex-col gap-4 xl:flex-row xl:gap-8">
          <div className="flex-1">
            <Skeleton className="h-6 w-32 bg-gray-800 rounded-lg mb-3" />
    ...
    <div className="mb-6">
      <div className="flex flex-col gap-6 xl:flex-row xl:gap-8">
        ...
        <div className="flex-1">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 xl:grid-cols-2 2xl:grid-cols-4 gap-3">
            <div className="bg-gray-800 rounded-lg p-3 border border-gray-700 hover:border-yellow-500/30 transition-colors duration-200 overflow-hidden">
              <div className="flex justify-between items-start">
                ...
                <div className="rounded-full bg-yellow-500 bg-opacity-20 p-1.5 flex-shrink-0">
            ...
            <div className="bg-gray-800 rounded-lg p-3 border border-gray-700 hover:border-green-500/30 transition-colors duration-200 overflow-hidden">
              <div className="flex justify-between items-start">
                <div className="flex-grow mr-2">
                ...
                <div className="rounded-full bg-green-500 bg-opacity-20 p-1.5 flex-shrink-0">
            ...
            <div className="bg-gray-800 rounded-lg p-3 border border-gray-700 hover:border-blue-500/30 transition-colors duration-200 overflow-hidden">
              <div className="flex justify-between items-start">
                <div className="flex-grow mr-2">
                  <p className="text-gray-400 text-xs">Entry Price</p>
                  <h3 className="text-xl font-bold">{gameStatus?.entryPriceInEth || 0} ETH</h3>
                </div>
                <div className="rounded-full bg-blue-500 bg-opacity-20 p-1.5 flex-shrink-0">
            ...
            <div className="bg-gray-800 rounded-lg p-3 border border-gray-700 hover:border-red-500/30 transition-colors duration-200 overflow-hidden">
              <div className="flex justify-between items-start">
                <div className="flex-grow mr-2">
                ...
                <div className="rounded-full bg-red-500 bg-opacity-20 p-1.5 flex-shrink-0">
        ...
        <div className="flex-1">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 xl:grid-cols-3 gap-3">
            ...
            <div className="bg-gray-800 rounded-lg p-3 border border-gray-700 hover:border-purple-500/30 transition-colors duration-200 overflow-hidden">
              <div className="flex justify-between items-start">
                <div className="flex-grow mr-2">
                  <p className="text-gray-400 text-xs">Avg Score</p>
                  <h3 className="text-xl font-bold" id="avgScore">{formatNumber(stats?.avgScore || 0)}</h3>
                </div>
                <div className="rounded-full bg-purple-500 bg-opacity-20 p-1.5 flex-shrink-0">
