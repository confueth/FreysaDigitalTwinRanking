...
import { Heart, Code, ExternalLink, TerminalSquare, AtSign, Sparkles, Home, Users, Earth, BarChart2 } from 'lucide-react';
import { Link } from 'wouter';

export default function Footer() {
  return (
    <footer className="bg-gradient-to-b from-gray-900 to-gray-950 border-t border-gray-800/50 py-8 px-4 sm:px-6 text-center text-gray-300">
      <div className="container-responsive flex flex-col items-center">
        <div className="flex items-center flex-wrap justify-center mb-6 text-sm">
          ...
          <a 
            ...
            className="mx-1 font-medium text-purple-400 hover:text-purple-300 transition-colors link-hover px-1 py-0.5"
          >
            Confu.eth
          </a>
          ...
          <a 
            ...
            target="_blank" 
            rel="noopener noreferrer"
            className="mx-1 font-bold text-gradient-animated hover:from-blue-300 hover:to-purple-300 transition-transform duration-300 px-1 py-0.5"
          >
            Freysa.ai
        ...
        <div className="flex flex-wrap justify-center gap-2 mb-6 sm:hidden">
          <Link to="/">
            <div className="bg-gray-800 hover:bg-gray-700 px-3 py-1.5 rounded-full text-xs flex items-center transition-colors">
